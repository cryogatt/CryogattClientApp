...
var positional_scanner_storage_operations_1 = require("../../../reader/storage-operations/positional-scanner-storage-operations");
var toastr = require("toastr");
var StoragePositionalGenericAssignment = /** @class */ (function () {
    // Constructor
    function StoragePositionalGenericAssignment(dialogController) {
    ...
    StoragePositionalGenericAssignment.prototype.bind = function () {
    ...
    StoragePositionalGenericAssignment.prototype.unbind = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StoragePositionalGenericAssignment.prototype.attached = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    StoragePositionalGenericAssignment.prototype.activate = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    // Upon pressing enter
    StoragePositionalGenericAssignment.prototype.handleKeyPress = function (evt) {
    ...
    // Update database
    StoragePositionalGenericAssignment.prototype.confirm = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Add to database
                        return [4 /*yield*/, Server.Http_AddItem(this.apiPath + '/' + this.type, this.item).then(function (data) {
                                if (data) {
                                ...
                                _this.controller.close(true, { "primaryContainer": _this.primaryContainer, "materials": _this.materials, "material": _this.material, "type": _this.type });
    ...
    StoragePositionalGenericAssignment.prototype.startReader = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        this.storageOperations = new positional_scanner_storage_operations_1.PositionalScannerStorageOperations(reader_types_1.ReaderType.CRYOGATT_SR012); // TODO - Remove hardcoded dependency on neck reader and replace with some method of a selection of a bulk reader
    ...
    StoragePositionalGenericAssignment.prototype.stopReader = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
    ...
    StoragePositionalGenericAssignment.prototype.pollReader = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    StoragePositionalGenericAssignment.prototype.validTagFound = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StoragePositionalGenericAssignment.prototype.singleItemScanned = function () {
    ...
    StoragePositionalGenericAssignment.prototype.readerFoundNewItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
    ...
    StoragePositionalGenericAssignment.prototype.itemIsRecognised = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var recongised;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, server_1.Http_GetTagsIdentity(this.storageOperations.changedSlots).then(function (data) {
    ...
    StoragePositionalGenericAssignment.prototype.tagIdentIsValid = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var tagIdent, tagType;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, reader_1.Reader_Ident(this.storageOperations.reader.readerId, this.storageOperations.changedSlots[0].UID[0]).catch(function (error) {
                            console.log(error);
    ...
    StoragePositionalGenericAssignment.prototype.initItem = function () {
        if (this.primaryContainer) {
    ...
    StoragePositionalGenericAssignment.prototype.loadBatches = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ], StoragePositionalGenericAssignment.prototype, "slot", void 0);
    __decorate([
        aurelia_framework_1.bindable({ defaultBindingMode: aurelia_framework_1.bindingMode.twoWay }),
        __metadata("design:type", Array)
    ], StoragePositionalGenericAssignment.prototype, "types", void 0);
    __decorate([
        aurelia_framework_1.bindable({ defaultBindingMode: aurelia_framework_1.bindingMode.twoWay }),
        __metadata("design:type", String)
    ], StoragePositionalGenericAssignment.prototype, "type", void 0);
    __decorate([
        aurelia_framework_1.bindable({ defaultBindingMode: aurelia_framework_1.bindingMode.twoWay }),
        __metadata("design:type", Number)
    ], StoragePositionalGenericAssignment.prototype, "containerState", void 0);
    __decorate([
        aurelia_framework_1.bindable({ defaultBindingMode: aurelia_framework_1.bindingMode.twoWay }),
        __metadata("design:type", material_1.MaterialBatch)
    ], StoragePositionalGenericAssignment.prototype, "material", void 0);
    __decorate([
        aurelia_framework_1.bindable({ defaultBindingMode: aurelia_framework_1.bindingMode.twoWay }),
        __metadata("design:type", Array)
    ], StoragePositionalGenericAssignment.prototype, "materials", void 0);
    StoragePositionalGenericAssignment = __decorate([
        aurelia_dependency_injection_1.transient(),
        aurelia_dependency_injection_1.autoinject(),
        __metadata("design:paramtypes", [aurelia_dialog_1.DialogController])
    ], StoragePositionalGenericAssignment);
    return StoragePositionalGenericAssignment;
}());
exports.StoragePositionalGenericAssignment = StoragePositionalGenericAssignment;
//# sourceMappingURL=storage-positional-generic-assignment.js.map