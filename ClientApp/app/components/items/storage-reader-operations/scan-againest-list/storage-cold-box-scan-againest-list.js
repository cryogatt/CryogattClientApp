...
var StorageColdBoxScanAgainestList = /** @class */ (function (_super) {
    __extends(StorageColdBoxScanAgainestList, _super);
    function StorageColdBoxScanAgainestList(storage, router) {
        var _this = _super.call(this, reader_types_1.ReaderType.CRYOGATT_R10102) || this;
    ...
    StorageColdBoxScanAgainestList.inject = function () { return [aurelia_router_1.Router]; };
    // Initialise reader and setup internal array
    StorageColdBoxScanAgainestList.prototype.startReader = function () {
    ...
    // On loop
    StorageColdBoxScanAgainestList.prototype.pollReader = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    StorageColdBoxScanAgainestList.prototype.foundBox = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StorageColdBoxScanAgainestList.prototype.boxHasListItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var it, cnts;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StorageColdBoxScanAgainestList.prototype.pickItems = function () {
        ...
        this.theRouter.navigate("coldBoxSlotsScanAgainestList");
    };
    StorageColdBoxScanAgainestList = __decorate([
        aurelia_dependency_injection_1.inject(aurelia_router_1.Router),
        __metadata("design:paramtypes", [generic_storage_1.GenericStorage, aurelia_router_1.Router])
    ], StorageColdBoxScanAgainestList);
    return StorageColdBoxScanAgainestList;
}(box_positional_storage_scanner_1.BoxPositionalStorageScanner));
exports.StorageColdBoxScanAgainestList = StorageColdBoxScanAgainestList;
//# sourceMappingURL=storage-cold-box-scan-againest-list.js.map