...
var StorageColdBoxSlotsScanAgainestList = /** @class */ (function () {
    function StorageColdBoxSlotsScanAgainestList(genericBoxDisplay, dialogController) {
        this.noOfReads = 0;
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.activate = function () {
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.deactivate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.refreshList = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.confirm = function () {
        this.boxDisplay.confirm();
    };
    StorageColdBoxSlotsScanAgainestList.prototype.update = function () {
        this.boxDisplay.update();
    };
    StorageColdBoxSlotsScanAgainestList.prototype.register = function () {
        this.boxDisplay.registerBox();
    };
    // Initialise reader and setup internal array
    StorageColdBoxSlotsScanAgainestList.prototype.startReader = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var _a, _b;
    ...
    // On loop
    StorageColdBoxSlotsScanAgainestList.prototype.pollReader = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.monitorHealthStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.monitorBatteryLife = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var batteryLife;
            return __generator(this, function (_a) {
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.monitorTemperature = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    StorageColdBoxSlotsScanAgainestList.prototype.launchTemperatureStatsDlg = function () {
        // Launch a modal dialogue 
    ...
    StorageColdBoxSlotsScanAgainestList = __decorate([
    ...
    ], StorageColdBoxSlotsScanAgainestList);
    return StorageColdBoxSlotsScanAgainestList;
}());
exports.StorageColdBoxSlotsScanAgainestList = StorageColdBoxSlotsScanAgainestList;
//# sourceMappingURL=storage-cold-box-slots-scan-againest-list.js.map