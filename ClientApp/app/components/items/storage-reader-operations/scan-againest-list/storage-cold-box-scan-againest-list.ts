...
@inject(Router)
export class StorageColdBoxScanAgainestList extends BoxPositionalStorageScanner {
    ...
    constructor(storage: GenericStorage, router: Router) {

        super(ReaderType.CRYOGATT_R10102);
