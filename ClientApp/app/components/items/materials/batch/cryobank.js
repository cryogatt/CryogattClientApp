...
var Cryobank = /** @class */ (function () {
    // Constructor
    function Cryobank(storage, materials) {
        this.storage = storage;
        this.materials = materials;
    }
    // Sets up the specific bindings for Materials
    Cryobank.prototype.activate = function (routeParams) {
    ...
    Cryobank.prototype.setPath = function (routeParams) {
        return this.storage.apiPath + "/" + routeParams.item + "?BATCH_TYPE=" + "Cryobank";
    };
    Cryobank = __decorate([
...
exports.Cryobank = Cryobank;
//# sourceMappingURL=cryobank.js.map