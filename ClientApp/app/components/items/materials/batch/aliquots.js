...
var Aliquots = /** @class */ (function () {
    // Constructor
    function Aliquots(storage, materials) {
        this.storage = storage;
        this.materials = materials;
    }
    // Sets up the specific bindings for Materials
    Aliquots.prototype.activate = function (routeParams) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                this.storage.schema.set("Description", "Description"); // TODO - Change here
    ...
    Aliquots.prototype.setPath = function (routeParams) {
        return this.storage.apiPath + "/" + routeParams.item[0] + "?BATCH_TYPE=" + routeParams.item[1];
    };
    Aliquots = __decorate([
...
exports.Aliquots = Aliquots;
//# sourceMappingURL=aliquots.js.map