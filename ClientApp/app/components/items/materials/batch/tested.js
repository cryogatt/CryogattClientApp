...
var Tested = /** @class */ (function () {
    // Constructor
    function Tested(storage, materials) {
        this.storage = storage;
        this.materials = materials;
    }
    // Sets up the specific bindings for Materials
    Tested.prototype.activate = function (routeParams) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                this.storage.title = " Viability Tested";
    ...
    Tested.prototype.setPath = function (routeParams) {
        return this.storage.apiPath + "/" + routeParams.item + "?BATCH_TYPE=" + "Viability Tested";
    };
    Tested = __decorate([
