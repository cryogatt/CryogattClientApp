...
var MaterialList = /** @class */ (function () {
    ...
    // Constructor
    function MaterialList(storage, materials) {
        this.storage = storage;
        this.materials = materials;
    }
    // Sets up the specific bindings for Materials
    MaterialList.prototype.bind = function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _a = this;
                        _c = (_b = Jsonmap).Server_ConvertToMaterialInfo;
                        return [4 /*yield*/, server_1.Http_GetItems("MaterialInfo")];
                    case 1:
                        // Get Material header fields for table
                        _a.materialInfos = _c.apply(_b, [_d.sent()]);
                        ...
                        return [4 /*yield*/, this.storage.fetch(this.storage.apiPath, json_map_1.Server_ConvertToMaterial)];
                    case 2:
                        // Fetch the data using the Web API
                        _d.sent();
                        return [2 /*return*/];
    ...
    MaterialList.prototype.create = function () {
        var item = this.materials.getNew();
...
//# sourceMappingURL=material-list.js.map